...
|
*/
$config['encryption_key'] = 'jaWSj7h05auD2xrklNvnelWLpJZErhF4';
...
$config['sess_cookie_name'] = 'bl_session';
...
$config['csrf_token_name'] = 'bl_csrf_token';
$config['csrf_cookie_name'] = 'bl_csrf_cookie';
